...
/**
 * متن معرفی پیش‌فرض. مثل رزومه، از یک جا خوانده می‌شود تا سفارشی‌سازی و قالب
 * دو حرف نزنند. هر چه در سفارشی‌سازی نوشته شود جای این را می‌گیرد.
 */
function catalyzer_default_bio() {
	return "دکتر سینا رضادوست، داروساز و دانش‌آموخته‌ی دبیرستان هاشمی‌نژاد ۱، شیمی کنکور را در مدارس سمپاد تدریس می‌کند. دانش‌آموزانی که با او کار کرده‌اند رتبه‌های ۲، ۳، ۴، ۶ و ۹ کنکور را آورده‌اند.\n\nطراحی آزمون‌های کشوریِ قلم‌چی و خیلی سبز، شیمی را از سمت طراح سؤال هم به او نشان داده است؛ همان چیزی که سر کلاس تبدیل می‌شود به اینکه دانش‌آموز بداند هر تیپ سؤال از کجا می‌آید و از کدام در باید سراغش برود.";
}

/**
 * رزومه‌ی پیش‌فرض — عین چیزی که خودِ سینا داده است.
 *
 * پیش‌فرضِ ثبت‌شده در «سفارشی‌سازی» روی صفحه‌ی سایت اعمال نمی‌شود، پس هم آنجا و
 * هم در قالبِ بخش «درباره» از همین یک تابع خوانده می‌شود تا دو جا از هم جدا
 * نیفتند. هر چیزی که در سفارشی‌سازی نوشته شود جای این را می‌گیرد.
 */
function catalyzer_default_credentials() {
	return implode( "\n", array(
		'دکتر داروساز',
		'مدرس کنکور مدارس سمپاد',
		'مدرس رتبه‌های ۲، ۳، ۴، ۶، ۹ و ... کنکور',
		'طراح آزمون‌های کشوری قلم‌چی و خیلی سبز',
		'دانش‌آموخته‌ی هاشمی‌نژاد ۱',
	) );
}
